...
public class BottomBar {
    ...
    public BottomBar(Activity _activity) {
        activity = _activity;
        BottomStripLayout = (RelativeLayout) activity.findViewById(R.id.BottomStripLayout);
        bottom_bar_play_pause_current = (ImageView) activity.findViewById(R.id.bottom_bar_play_pause_current);
        setupBottomBar();
    }
    ...
    private void setupBottomBarContent() {
        ImageView bottom_bar_album_art = (ImageView) activity.findViewById(R.id.bottom_bar_album_art);
        TextView bottom_bar_title = (TextView) activity.findViewById(R.id.bottom_bar_title);
        TextView bottom_bar_album_artist = (TextView) activity.findViewById(R.id.bottom_bar_album_artist);
        ImageView bottom_bar_play_pause_current = (ImageView) activity.findViewById(R.id.bottom_bar_play_pause_current);
