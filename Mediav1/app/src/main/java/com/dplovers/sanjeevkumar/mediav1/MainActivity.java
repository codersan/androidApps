package com.dplovers.sanjeevkumar.mediav1; //com.dplovers
...
public class MainActivity extends AppCompatActivity {
    ...
    public final static String EXTRA_MESSAGE_POS = "com.dplovers.sanjeevkumar.mediav1.MESSAGE_POS";
    public final static String EXTRA_MESSAGE_SRC = "com.dplovers.sanjeevkumar.mediav1.MESSAGE_SRC";
    ...
    public static boolean play_list = true;
    public static String current_song_file_path = "";
    ...
    public void addClickListenerOnAlbumListItem() {
        ...
        album_list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int position, long arg3) {
                ...
                play_next = searchText.length() > 0 ? false: true;
                Log.i("playScreenUI11", MainActivity.current_song_file_path);
            }
        });
    }
